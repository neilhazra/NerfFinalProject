...
model.load_state_dict(torch.load("./model_256/nerf_model_50000_.model"))
...
with torch.no_grad():
    for i in [131]:
        ...
        cv2.imwrite('test_L10_256_50k.png', np.flip((rendered_colors.detach().cpu().numpy()*255).astype(int), axis=-1))
