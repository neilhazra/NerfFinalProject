...
model.load_state_dict(torch.load("./model_object_N2/nerf_model_90000_.model"))
...
with torch.no_grad():
    ...
    #for i in [131]:
        ...
        for split in range(4):
            ...
            rendered_colors, _ = model.forward_eval(split_translation.cuda(), split_world_direction.cuda(), 2, 6, 100)
        ...
        # cv2.imwrite('test_131_N2_90k.png', np.flip((rendered_colors.detach().cpu().numpy()*255).astype(int), axis=-1))
